    ...
    def __init__(self, *args, **kwargs):
        ...
        def Display(self, M, N):
            ...
            self.Details = ctk.CTkButton(
                ...
                fg_color="#E74C3C",
                border_color="#E74C3C",
                command=lambda: dispPie(self, M, N),
            )
        ...
        def pressedCalculate():
            ...
            if self.ten.get() == "":
                messagebox.showerror(
                    "Error", "Please enter the tenure of your investment"
                )
                return
            ...
            if self.roi.get() == "":
                messagebox.showerror(
                    "Error", "Please enter the Rate of Return on your investment"
                )
                return
        ...
        self.Amt = ctk.CTkEntry(
            master=self.InputFrame, placeholder_text="2000", border_color="#E74C3C"
        )
        ...
        self.ten = ctk.CTkComboBox(
            master=self.InputFrame,
            values=["5", "10", "15", "20", "25", "30", "35"],
            border_color="#E74C3C",
            button_color="#E74C3C",
            dropdown_hover_color="#02b165",
        )
        ...
        self.roi = ctk.CTkEntry(
            master=self.InputFrame, placeholder_text="12%", border_color="#E74C3C"
        )
        ...
        self.ls = ctk.CTkEntry(
            master=self.InputFrame, placeholder_text="1,00,000", border_color="#E74C3C"
        )
