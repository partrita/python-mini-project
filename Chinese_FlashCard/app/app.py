...
class MainApp(tk.Tk):
    ...
    def widgets(self):
        ...
        self.canvas = tk.Canvas(
            bg="#83FCE3", border=1, width=190, height=190, relief="groove"
        )

        self.quit_btn = tk.Button(
            cursor="target", bg="#C2FCEE", text="quit", command=self.quit
        )
